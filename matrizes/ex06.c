...
void matrizTranspostaInPlace(int m[][QTD_COLUNAS], int lins, int cols) {
    int aux;
    if (lins != cols) {
        printf("Não é possível realizar esta operação, pois a matriz não é quadrada!\n");
        return;
...
void multiplicaMatrizes(int a[][QTD_COLUNAS], int linsA, int colsA,
